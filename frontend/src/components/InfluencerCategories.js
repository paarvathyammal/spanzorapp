...
export default function InfluencerCategories() {
  const categories = [
    ...
    ,{
      title: 'Join Spanzor — built for creators',
      punch: 'Create a free profile, get matched to brand briefs, and manage payouts in one dashboard.',
      metrics: [],
      includes: [
        'Free listing',
        'Auto‑matched campaigns',
        'Transparent payouts',
              ...
              <div className={`card h-100 shadow-sm border-0 category-card ${c.featured ? 'category-featured' : ''}`}>
                <div className="card-body p-5 d-flex flex-column">
                  ...
                  <div className="mt-auto">
                    ...
                    {c.joinCard && (
                      <div className="small text-body-secondary mt-2 text-center">It’s free. Takes less than 2 minutes.</div>
                    )}
                  </div>
                </div>
              </div>
